...
import { Instagram, Facebook, TwitterIcon as TikTok, Youtube } from "lucide-react"
...
export function SocialMediaSection() {
  ...
  return (
    (<section
      id="social-section"
      className="px-4 py-12 bg-gradient-to-br from-gray-900 to-black">
      <div className="max-w-sm mx-auto space-y-8">
        <div className="text-center">
          <h2
            className="text-3xl font-brand mb-4 bg-gradient-to-r from-[#C1121F] to-[#8B0000] bg-clip-text text-transparent">
            SÍGUENOS
          </h2>
          <p className="text-gray-400">Únete a nuestra comunidad vaper</p>
        </div>
        ...
        <div className="text-center glass-effect p-6 rounded-2xl">
          <h3 className="font-brand text-xl mb-2 text-[#C1121F]">¡COMPARTE TU EXPERIENCIA!</h3>
          <p className="text-gray-400 text-sm">Usa #VappeoExperience y aparece en nuestras historias</p>
        </div>
      </div>
    </section>)
  );
